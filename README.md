...
contains the source distributions of freenginx 1.28.0, [OpenSSL 3.5.6 LTS][2],
...
package is written into the project root with the name `nginx1.28.0.pkg`.
...
if notarization succeeds.  Use the command:
        ...
        $ xcrun stapler validate --verbose nginx1.28.0.pkg
